...
public class FourResultTable extends TournamentResultTable {
  ...
  public FourResultTable(Table table) {
    ...
    String rbs0(String s) { return s; } // for development
                                        // strings passed as parameters need to be internationalized
  ...
  public void addGameData(GameResult gameResult_, GameDeclaration gameDeclaration_) {
	...
	this.getModel().setValueAt(table.playerInGame(3), 0, 15);
	players[3] = table.playerInGame(3);
    }
  ...
  public void initComponents() {
    ...
    this.getColumnModel().getColumn(16).setCellRenderer(right);
    this.getColumnModel().getColumn(17).setCellRenderer(right);
    this.getColumnModel().getColumn(18).setCellRenderer(center);
  ...
  public void resize(float scale, FontMetrics fontMetrics) {
    ...
    String[] columnWidths = new String[] {
	    ...
	    "MMMMxxxx", "99", "99", "MMMMxxxx", "99", "99", "MMMMxxxx", "99", "99", "M"
    };
